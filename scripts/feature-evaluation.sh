...
for NAME in "${metadata_names[@]}"; do
    ...
    CMD="python $SCRIPT --train --path $DATA_PATH --norm $BEST_NORM --debug_path $DEBUG_PATH --leaderboard_path $LEADERBOARD_PATH --model $MODEL --kfold $KFOLD --strict"
