...
STEP="sliding_window_evaluation"
SCRIPT="vrscanner.py"
...
# Build full command
CMD="python $SCRIPT --$STEP --debug_path $DEBUG_PATH --leaderboard_path $LEADERBOARD_PATH --kfold $KFOLD --pktcount $PKTCOUNT --input_dim $INPUT_DIM --hidden_size $HIDDEN_SIZE --num_layers $NUM_LAYERS --dropout $DROPOUT --fusion_dim $FUSION_DIM --fc_hidden_size $FC_HIDDEN_SIZE --epoch $EPOCH --lr $LR --window_size $WINDOW_SIZE --step_size $STEP_SIZE --strict"
